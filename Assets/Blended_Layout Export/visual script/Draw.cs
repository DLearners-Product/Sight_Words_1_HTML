...
public class Draw : MonoBehaviour
{
   ...
   // public GameObject board;
    ...
    public void Start()
    {
        brush.GetComponent<LineRenderer>().SetColors(Color.black, Color.black);
        //this.GetComponent<LineRenderer>().SetColors(Color.black, Color.black);
        brush.GetComponent<LineRenderer>().SetWidth(0.05f, 0.05f);
   ...
   /* public void BUT_erase()
    {
        for (int i = LA_Clones.Length-1; i >= 0; i--)
        {
            if (LA_Clones[i] != null)
            {
